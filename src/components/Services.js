      ...
      <div className="container">
        ...
        <div className="services">
          <div className="service">
            ...
            <h3 className="service__heading">Development</h3>
            <p className="service__text">
              Building responsive front-end websites using React and can
              preovice serives in development.
            </p>
          </div>
          <div className="service">
            <div className="img">
            ...
            <p className="service__text">
              ...
              application using HTMl5, CSS3, JS(ES6),Bootstrap and React.
            </p>
          </div>
          <div className="service">
            <div className="img">
            ...
            <h3 className="service__heading">Time Management</h3>
            <p className="service__text">
              Making users happy by providing completed projects on time.
            </p>
          </div>
        </div>
      </div>
